...
@Component({
  selector: 'app-evaluartesisalumnodirectorescuela',
  templateUrl: './evaluartesisalumnodirectorescuela.component.html',
  styleUrls: ['./evaluartesisalumnodirectorescuela.component.css']
})
export class EvaluartesisalumnodirectorescuelaComponent implements OnInit {
 ...
 InscribirTesis=function(id){
    console.log(this.editing);
    if(this.editing==true){
      console.log(this.tesis);
      this.identificador=localStorage.getItem('id');
      this.tesiscomisioncapitulosService.getinscribirtesis(id).subscribe((data) => {
      alert('Tesis Inscrita');
      //console.log(data);
      this.router.navigateByUrl('/tesis_espera_directorescuela/'+ this.identificador);
    }, (error) => {
  console.log(error);
